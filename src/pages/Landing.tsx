...
import { Ticket, Zap, Users, BarChart3, CheckCircle, ArrowRight, Star, Shield, Clock } from "lucide-react";
const features = [{
  icon: Ticket,
...
const benefits = [{
  icon: CheckCircle,
  text: "Reduce response time by 70%"
}, {
  icon: Shield,
        ...
        <div className="container mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <Badge variant="secondary" className="bg-gradient-hero text-primary font-medium px-4 py-2">
            ...
            <div className="relative">
              ...
              <img src={heroImage} alt="QuickDesk Dashboard" className="relative rounded-3xl shadow-glow w-full h-auto" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-gradient-hero">
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => <Card key={index} className="border-0 shadow-card hover:shadow-elegant transition-all duration-300 bg-gradient-card">
          ...
          <Card className="border-0 bg-gradient-primary text-center p-12 shadow-glow">
            <CardContent className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link to="/login">
                  <Button variant="outline" size="xl" className="border-white w-full sm:w-auto bg-slate-50 text-center font-semibold text-sky-500">
                    Sign In
                  </Button>
                </Link>
              </div>
